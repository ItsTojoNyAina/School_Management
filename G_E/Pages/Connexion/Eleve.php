    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form action="../../php/traitement_log.php" class="sign-in-form" method="post">
          ...
          <form action="../../php/traitement_inscri.php" class="sign-up-form" method="post">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>Nouveau ?</h3>
            <p>
              Créez un compte et commencez à utiliser le site.
