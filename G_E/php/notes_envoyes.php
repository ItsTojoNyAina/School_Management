...
<div class="sidebar bg-white p-20 p-relative">
            ...
            <ul>
                ...
                <li>
                    <a class="flex align-center fs-14 black rad-6 p-10" href="../Pages/Back-office enseignant/profile.php">
                ...
                <li>
                    <a class="active flex align-center fs-14 black rad-6 p-10" href="../Pages/Back-office enseignant/cours.php">
                        <i class="fa-solid fa-graduation-cap fa-fw"></i>
                        <span>Cours</span>
                    </a>
                </li>
                <li>
                    <a class="flex align-center fs-14 black rad-6 p-10" href="../Pages/Back-office enseignant/Notes.php">
                        <i class="fa-regular fa-circle-user fa-fw"></i>
                        <span>Notes</span>
                    </a>
                </li>
                <li>
                    <a class="active flex align-center fs-14 black rad-6 p-10" href="../Pages/Back-office enseignant/Edt.php">
    ...
    <div class="content">
        <div class="container">
            ...
            <form action="traitement_notes.php" method="POST">
                ...
                <p style="color:#4CAF50; text-align:center;">enregistrés avec succes</p>
            </form>
        </div>
    </div>
